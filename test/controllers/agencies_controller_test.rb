...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { agency_number: @agency.agency_number, endereco: @agency.endereco } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { agency_number: @agency.agency_number, endereco: @agency.endereco } }
