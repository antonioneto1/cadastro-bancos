...
class AgenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agencium" do
    assert_difference('Agencium.count') do
      post agencia_url, params: { agencium: { agencia_id: @agencium.agencia_id, limite: @agencium.limite, numero_conta: @agencium.numero_conta } }
    end
  ...
  test "should update agencium" do
    patch agencium_url(@agencium), params: { agencium: { agencia_id: @agencium.agencia_id, limite: @agencium.limite, numero_conta: @agencium.numero_conta } }
